...
{
    public sealed partial class LabelCollection2 : UserControl
    {
        ...
        public static readonly DependencyProperty ItemsSourceProperty = DependencyProperty.Register(
            "ItemsSource", typeof(IEnumerable<Entry>), typeof(LabelCollection2), new PropertyMetadata(null, new PropertyChangedCallback(OnItemsSourceChanged)));
        public static readonly DependencyProperty TitleProperty = DependencyProperty.Register(
           "Title", typeof(string), typeof(LabelCollection2), new PropertyMetadata(null, new PropertyChangedCallback(OnTitleChanged)));
        public static readonly DependencyProperty DescriptionProperty = DependencyProperty.Register(
            "Description",typeof(string),typeof(LabelCollection2),new PropertyMetadata(null, new PropertyChangedCallback(OnDescriptionhanged)));
        public static readonly DependencyProperty DetailCommandProperty= DependencyProperty.Register(
            nameof(DetailCommand),typeof(ICommand),typeof(LabelCollection2), new PropertyMetadata(default(ICommand)));
        public static readonly DependencyProperty BgImageSourceProperty = DependencyProperty.Register(
            "BgImageSource", typeof(ImageSource), typeof(LabelCollection2), new PropertyMetadata(null, new PropertyChangedCallback(OnBgImageSourceChanged)));
        public static readonly DependencyProperty ClickItemCommandProperty = DependencyProperty.Register(
            nameof(ClickItemCommand), typeof(ICommand), typeof(LabelCollection2), new PropertyMetadata(default(ICommand)));
        public static readonly DependencyProperty IdProperty = DependencyProperty.Register(
            nameof(Id), typeof(string), typeof(LabelCollection2), new PropertyMetadata(null));
        private static void OnItemsSourceChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            (d as LabelCollection2).ItemsList.ItemsSource = e.NewValue as IEnumerable<Entry>;
        }
        private static void OnTitleChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            (d as LabelCollection2).TitleTextBlock.Text = e.NewValue as string;
        }
        private static void OnDescriptionhanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            (d as LabelCollection2).DesTextBlock.Text = e.NewValue as string;
        }
        private static void OnBgImageSourceChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            (d as LabelCollection2).BgImage.ImageSource = e.NewValue as ImageSource;
        }
